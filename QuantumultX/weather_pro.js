 ...
 */
let config = {
    darksky_api: "d7c91a610a328e272c977ae77b541ef1", //从https://darksky.net/dev/ 上申请key填入即可
    aqicn_api: "ddd007280794dfa21f9951cb33fca6ba5c46877d", //从http://aqicn.org/data-platform/token/#/ 上申请key填入即可
    huweather_apiKey: "af8f937aa17b4084977dfd10d11be725", //和风天气APIkey,可自行前往 https://dev.heweather.com/ 进行获取
    lat_lon: "28.57, 115.92", //请填写经纬度,直接从谷歌地图中获取即可
...
[未来12小时]
$[hourly($[month]/$[day] $[hour]:00 $[weatherIcon]$[weather] $[temperature]℃)]
